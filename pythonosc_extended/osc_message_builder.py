...
from pythonosc_extended import osc_message
from pythonosc_extended.parsing import osc_types
...
class OscMessageBuilder(object):
  ...
  _SUPPORTED_ARG_TYPES = (
      ARG_TYPE_FLOAT, ARG_TYPE_INT, ARG_TYPE_BLOB, ARG_TYPE_STRING, ARG_TYPE_RGBA, ARG_TYPE_DOUBLE, ARG_TYPE_TRUE, ARG_TYPE_FALSE)
